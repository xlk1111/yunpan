...
<nav class="navbar navbar-default navbar-fixed-top"
    ...
    <div class="container">
        <div class="navbar-header" style="float:left;">
            ...
            <a class="navbar-brand" href="share.action">分享</a>
            <a class="navbar-brand" href="#" target="more">更多</a>
        </div>
        <div id="navbar" style="float: right;">
            <ul class="nav navbar-nav">
                <li class="dropdown" style="width:100px">
                    <a href="#" class="dropdown-toggle" id="user" data-toggle="dropdown" role="button"
                       aria-haspopup="true" aria-expanded="false">
                        <img src="${pageContext.request.contextPath }/img/titalpicture.jpg" height="20px"
                             class="img-circle"/>
